    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden selection:bg-emerald-500/30">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <Link
                to="/signup"
                className="group flex items-center gap-3 px-8 py-4 rounded-2xl bg-emerald-500 text-black font-bold text-sm emerald-glow hover:bg-emerald-400 transition-all"
              >
                JOIN THE SWARM
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-square glass rounded-[40px] p-8 flex items-center justify-center emerald-glow overflow-hidden">
              {/* SVG Map Placeholder */}
              <div className="w-full h-full bg-emerald-500/5 rounded-3xl flex items-center justify-center border border-emerald-500/10">
                <span className="text-emerald-500/20 font-mono text-sm uppercase tracking-[0.5em] rotate-90">KERALA_MAP_OS</span>
              </div>
              {/* Floating Stats */}
              <div className="absolute bottom-12 right-12 glass p-6 rounded-3xl emerald-glow-strong border border-emerald-500/20">
      ...
      <section className="py-32 px-8 max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center mb-20">
          <h2 className="text-5xl font-bold tracking-tighter mb-4">Emergent <span className="text-emerald-500">Forecasting.</span></h2>
      ...
      <section className="py-32 px-8 text-center">
        <div className="max-w-3xl mx-auto glass p-16 rounded-[48px] border border-emerald-500/10 emerald-glow relative overflow-hidden">
          ...
          <h2 className="text-5xl font-bold tracking-tighter mb-6">Ready to <span className="text-emerald-500">Impact</span> the Swarm?</h2>
      ...
      <footer className="py-20 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <span className="text-[10px] font-mono text-white/20 uppercase tracking-widest">© 2026 Electoral Swarm Lab</span>
        </div>
      </footer>
    </div>
  );
